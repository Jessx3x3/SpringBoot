...
public class ApiService {
	...
	public Estudiante newEstudiante(@RequestParam("firstName") String firstName, @RequestParam("lastName") String lastName, @RequestParam("age") Integer age, @RequestParam("dormitorio") Long dormitorio) {
		
		Dormitorio newDormitorio = dormitorioService.getById(dormitorio);
		
		Estudiante newStudent = new Estudiante(firstName, lastName, age, newDormitorio);
